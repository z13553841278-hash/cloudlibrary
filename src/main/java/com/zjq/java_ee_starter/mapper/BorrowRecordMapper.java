...
public interface BorrowRecordMapper {
        ...
        @Results({
                        ...
                        @Result(property = "returnDate", column = "return_date"),
                        @Result(property = "status", column = "status"),
                        @Result(property = "user", javaType = com.zjq.java_ee_starter.entity.User.class, column = "user_id", one = @One(select = "com.zjq.java_ee_starter.mapper.UserMapper.findUserbyId")),
                        @Result(property = "book", javaType = com.zjq.java_ee_starter.entity.Book.class, column = "book_id", one = @One(select = "com.zjq.java_ee_starter.mapper.BookMapper.findBookById"))
        })
